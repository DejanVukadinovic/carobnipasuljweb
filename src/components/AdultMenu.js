	...
	return (
		<div className="px-4">
			<div className="flex flex-col">
				<div className="grid grid-cols-6 border-gray-300 border-b-2 py-2">
					...
					<div className="col-span-1 text-center border-gray-400 border-l-2">Subota</div>
				</div>
				<div className="grid grid-cols-6">{Jelovnik} </div>
			</div>
		</div>
	);
}
